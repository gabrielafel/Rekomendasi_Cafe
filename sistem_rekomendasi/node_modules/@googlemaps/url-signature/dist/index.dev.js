var urlSignature = (function (exports, Base64, HmacSHA1, url) {
	'use strict';
	...
	var TypeError$8 = global_1.TypeError; // `RequireObjectCoercible` abstract operation
	...
	var TypeError$6 = global_1.TypeError; // `Assert: IsCallable(argument) is true`
	...
	var TypeError$5 = global_1.TypeError; // `OrdinaryToPrimitive` abstract operation
	...
	var TypeError$3 = global_1.TypeError; // eslint-disable-next-line es/no-object-defineproperty -- safe
	...
	var classofRaw = function (it) {
	  return stringSlice$4(toString(it), 8, -1);
	};
	...
	var classof = toStringTagSupport ? classofRaw : function (it) {
	  ...
	  : typeof (tag = tryGet(O = Object$2(it), TO_STRING_TAG)) == 'string' ? tag // builtinTag case
	...
	*/
	...
	function createSignature(unsignedUrl, secret) {
	  if (typeof unsignedUrl === "string") {
	    unsignedUrl = new url.URL(unsignedUrl);
	...
	function signUrl(unsignedUrl, secret) {
	  ...
	  return new url.URL(unsignedUrl.toString() + "&signature=" + createSignature(unsignedUrl, secret));
	}
